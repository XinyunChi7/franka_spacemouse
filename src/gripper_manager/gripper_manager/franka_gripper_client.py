...
class GripperClient(Node):
    def __init__(self):
        ...
        self.declare_parameter("gripper_epsilon_inner", DEFAULT_GRIPPER_EPSILON_INNER)
        self.declare_parameter("gripper_epsilon_outer", DEFAULT_GRIPPER_EPSILON_OUTER)
        ...
        if namespace != "":
            namespace = "/" + namespace
        grasp_action_topic = (
            namespace + self.get_parameter("grasp_action_topic").get_parameter_value().string_value
        )
        homing_action_topic = (
            namespace
        ...
        joint_states_topic = (
            namespace + self.get_parameter("joint_states_topic").get_parameter_value().string_value
        )
        self._gripper_epsilon_inner = float(
            self.get_parameter("gripper_epsilon_inner").get_parameter_value().string_value
        )
        self._gripper_epsilon_outer = float(
            self.get_parameter("gripper_epsilon_outer").get_parameter_value().string_value
        )
        self.gripper_speed = float(
            self.get_parameter("gripper_speed").get_parameter_value().string_value
        )
        self.gripper_force = float(
            self.get_parameter("gripper_force").get_parameter_value().string_value
        )
        ...
        self._action_client = ActionClient(self, Grasp, grasp_action_topic)
